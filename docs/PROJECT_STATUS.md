...
| 5. Skill workflow | Привести SKILL.md и references к canonical bundle, трём CLI-командам и lifecycle contract | В review; router и семь focused references проходят executable skill-contract tests |
